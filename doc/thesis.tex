...
% ]
\usepackage{fancybox}
\fancyput(-1cm,-12.5cm){\rotatebox[origin=cc]{90}{\centerline{------------------------------------------装--------------------订--------------------线------------------------------------------}}}
\usepackage{fancyhdr}
\makeatletter
...
%   \includepdf[offset=-.2cm -0.65in]{title.pdf}
...
% \includepdf[offset=-.2cm -0.65in]{title.pdf}
\includepdf[pagecommand={\thispagestyle{myheadings}}, offset=-.2cm -0.65in]{title.pdf}
